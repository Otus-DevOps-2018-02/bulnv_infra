...
проверьте... выполнено
 ...
 # Homework-9
  ...
  # Homework-12
  - Пришлось перекатиться в линукс из win\WSL окружение т.к не все корректно работало
  - Установил vagrant, vbox, molecule
  - Настройка varant для провижининга ролями
  - тестироваение ролей при помощи molecule+testinfra
  - перепаковка образа с использованием ролей
  - NB: задание с * не дожато - обязательно доделть позже
